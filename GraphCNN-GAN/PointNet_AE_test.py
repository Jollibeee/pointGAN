...
parser.add_argument('--model', default='pointnet', help='Model name [default: model]')
parser.add_argument('--model_path', default='log_pointnet_Chair/model.ckpt', help='model checkpoint file path [default: log/model.ckpt]')
