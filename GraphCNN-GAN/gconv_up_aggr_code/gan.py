...
import time
import random
from src.tf_utils import safe_log
...
class GAN:
	...
	def eval(self, data, noise):
		feed_dict = {self.x: data, self.z: noise, self.is_training: False}
		return self.sess.run((self.x, self.x_hat), feed_dict=feed_dict)
