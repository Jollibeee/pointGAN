...
import sys
# sys.path.append( os.path.dirname(os.path.abspath(os.path.dirname("file")))) # latent_3D
...
class W_GAN_GP(GAN):
    ...
    def __init__(self, name, learning_rate, lam, n_output, noise_dim, discriminator, generator, beta=0.5, gen_kwargs={}, disc_kwargs={}, graph=None):
        ...
        print("dis", self.discriminator)
        print("gen", self.generator)
