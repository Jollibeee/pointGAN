...
from src.encoders_decoders import encoder_with_convs_and_symmetry, decoder_with_fc_only, ldgcnn_encoder, ldgcnn_decoder
...
def mlp_architecture_ldgcnn(n_pc_points, bneck_size, bneck_post_mlp=False):
    ''' Single class experiments.
    '''
    if n_pc_points != 2048:
        raise ValueError()

    encoder = ldgcnn_encoder
    decoder = ldgcnn_decoder
