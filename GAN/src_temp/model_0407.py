...
class Gen3(nn.Module):
    def __init__(self, args):
        ...
        self.model = nn.Sequential(
            nn.Linear(in_features=self.feat_dim, out_features=64, bias=False),
            ...
            nn.Linear(in_features=1024, out_features=2048 * 3, bias=False),
        )
...
#         self.bn5 = nn.BatchNorm1d(args.feat_dim)
#
#         self.conv1 = nn.Sequential(nn.Conv2d(3 * 2, 64, kernel_size=1, bias=True),
#                                    self.bn1,
#                                    nn.LeakyReLU(negative_slope=0.2))
#         self.conv2 = nn.Sequential(nn.Conv2d(64 * 2, 64, kernel_size=1, bias=True),
#                                    self.bn2,
#                                    nn.LeakyReLU(negative_slope=0.2))
#         self.conv3 = nn.Sequential(nn.Conv2d(64 * 2, 128, kernel_size=1, bias=True),
#                                    self.bn3,
#                                    nn.LeakyReLU(negative_slope=0.2))
#         self.conv4 = nn.Sequential(nn.Conv2d(128 * 2, 256, kernel_size=1, bias=True),
#                                    self.bn4,
#                                    nn.LeakyReLU(negative_slope=0.2))
#         self.conv5 = nn.Sequential(nn.Conv1d(512, args.feat_dim, kernel_size=1, bias=True),
#                                    self.bn5,
#                                    nn.LeakyReLU(negative_slope=0.2))
#
...
#         )
#
#         self.mu_layer = nn.Linear(512, args.feat_dim, bias=True)
#         self.std_layer = nn.Linear(512, args.feat_dim, bias=True)
#
...
class Encoder(nn.Module):
    def __init__(self, config):
        ...
        self.mu_layer = nn.Linear(256, config.feat_dim, bias=True)
        self.std_layer = nn.Linear(256, config.feat_dim, bias=True)
...
class Discriminator(nn.Module):
    def __init__(self, config):
        ...
        self.model = nn.Sequential(
            ...
            nn.Linear(config.feat_dim, 512, bias=True),
            nn.ReLU(inplace=True),
...
class Generator(nn.Module):
    def __init__(self, config):
        ...
        self.model = nn.Sequential(
            nn.Linear(in_features=config.feat_dim, out_features=64, bias=True),
            nn.ReLU(inplace=True),
            ...
            nn.Linear(in_features=1024, out_features=2048 * 3, bias=True),
        )
